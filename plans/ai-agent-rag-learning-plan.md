...
> 总量：**49 个任务 / 162 小时**。每周 10 小时 → 约 **17 周**；每周 8 小时 → 约 21 周。执行顺序见 **[ROADMAP.md](../ROADMAP.md)**。
...
| 阶段 | 任务卡 | 序号 | 工时 | 过关卡片的核心硬指标 |
|---|---|---|---|---|
| 一 · LLM API 基本功 | [stage-1](../stages/stage-1-llm-api.md) | #01–#12 | 32h | 结构化输出 50 次 0 失败；缓存命中 ≥ 90% |
| 二 · RAG 全链路 | [stage-2](../stages/stage-2-rag.md) | #13–#21 | 30h | 冷门事实召回 8/10；正确拒答 9/10；权限零泄露 |
| 三 · 评估体系 | [stage-3](../stages/stage-3-eval.md) | #22–#26 | 20h | 黄金集 ≥ 50 条；重复跑波动 < 3%；Recall@5 提升 ≥ 5 点 |
| 四 · Agent | [stage-4](../stages/stage-4-agent.md) | #27–#33 | 36h | 手写循环跑通；三道护栏可触发；写操作 100% 拦截 |
| 五 · 生产化 | [stage-5](../stages/stage-5-production.md) | #34–#41 | 24h | 降本 ≥ 40% 且 eval 掉分 < 2%；红队 0 攻破 |
| 六 · 补基础 + 选方向 | [stage-6](../stages/stage-6-fundamentals.md) | #42–#48 | 20h | 5 个概念能结合亲历现象自述；HNSW 参数曲线 |

**执行顺序、优先级（P0/P1/P2）、依赖关系和"时间不够怎么砍"见 [ROADMAP.md](../ROADMAP.md)。**
